  ...
  return (
   <div className='bg-gray-100'>
     <div className='max-w-screen container mx-auto py-20 px-5'>
        <HeadingSection subheading="Our Trusted Partners" heading=" Companies We've Worked With" description="We've partnered with some of the most innovative and leading companies to bring the best soluton to you" />
